...
const char* ssid = "your_SSID";      // Access point name (SSID)
const char* password = "your_PASSWORD"; // Access point password

int GREEN_LED_PIN = 32;
int RED_LED_PIN = 33;
...
void setup() {
  ...
  connectToWifi();
  beginServer();
  myservo.attach(2); // Pin where the servo motor is connected
  dht.begin();
}
...
void handleRoot() {
  ...
  page += "<title>ESP32 Web Server</title>";
